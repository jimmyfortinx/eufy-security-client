...
export declare let MEDIA_INFO: MediaInfo | null;
...
export declare const initMediaInfo: () => Promise<MediaInfo>;
export declare const analyzeCodec: (data: Buffer) => Promise<any>;
